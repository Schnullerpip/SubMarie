...
onMounted(() => {
    ...
    const boxA = Bodies.rectangle(0, 1000, 80, 80);
    const boxB = Bodies.rectangle(100, 1000, 80, 80);
    const ground = Bodies.rectangle(appDimensions.width/2, appDimensions.height - 60, appDimensions.width, 60, { isStatic: true });

    // add all of the bodies to the world
    Composite.add(engine.world, [boxA, boxB, ground, ...bodies]);
