...
export class MouseInput {
    ...
    constructor(private root: Element, private mouse: Mouse, private bell: Body, private render: Render) {
    ...
    private setTouchHandler() {
        this.root.addEventListener("touchstart", () => (this.cursorVisible = true));
        this.root.addEventListener("touchend", () => (this.cursorVisible = false));
    }
    ...
    public getVector(): Vector {
        return Vector.normalise(Vector.sub(this.bell.position, this.mouse.position));
    }
}
